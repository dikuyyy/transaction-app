            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="harga-beli">Harga Dasar</label>
                            <input class="form-control" name="base_price" id="harga-beli">
                        </div>
                        <div class="mb-3">
                            <label for="name">Harga Jual</label>
                            <input class="form-control" name="selling_price" id="harga-jual">
                        </div>
                        <div class="mb-3">
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="harga-beli">Harga Dasar</label>
                            <input class="form-control" type="number" name="base_price" id="harga-beli-update-field">
                        </div>
                        <div class="mb-3">
                            <label for="name">Harga Jual</label>
                            <input class="form-control" type="number" name="selling_price" id="harga-jual-update-field">
                        </div>
                        <div class="mb-3">
                            <label for="tags">Tags</label>
                    ...
                    {data: 'created_at', name: 'created_at'},
                    {
                        ...
                        render: (data, type, row) => {
                            ...
                            <div style="text-align: center">
                                <form method="post" action="{{url('/jasa')}}/${row.id}">
                                @csrf
                            @method('delete')
                            <div class="btn-group">
